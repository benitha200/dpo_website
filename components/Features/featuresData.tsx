...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      " Identify and assess vulnerabilities within your organization's data ecosystem with our intuitive risk assessment tool. From internal processes to external threats, our comprehensive evaluation helps you pinpoint areas of concern and prioritize mitigation strategies. ",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Data Protection Trainings",
    paragraph:
      " Our platform provides a range of training modules designed to educate employees at all levels about data protection best practices. From basic principles to advanced security protocols, our training materials empower your workforce to recognize potential risks and respond effectively.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Data Protection and Compliance Certification",
    paragraph:
      "Initiate the Certification Process and Obtain Your Accreditation Directly Through Our Platform",
  },
